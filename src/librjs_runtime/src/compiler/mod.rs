...
pub fn lower_hir_to_bytecode(interner: string_interer::StringInterner, hir: &hir::Program) -> emitter::CompiledProgram {
    let builder = bytecode_builder::BytecodeBuilder::new();
    builder.lower_program(hir, interner)
}
