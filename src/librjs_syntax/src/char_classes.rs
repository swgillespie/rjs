...
impl CharClassExt for char {
    ...
    fn is_es_identifier_start(self) -> bool {
        ...
        self.is_letter_uppercase() || self.is_letter_lowercase() ||
        self.is_letter_titlecase() || self.is_letter_modifier() || self.is_letter_other() ||
    ...
    fn is_es_identifier_part(self) -> bool {
        ...
        self.is_es_identifier_start() || self.is_mark_nonspacing() ||
        self.is_mark_spacing_combining() || self.is_number_decimal_digit() ||
